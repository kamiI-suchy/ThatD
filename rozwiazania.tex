...
Zapisujemy macierz rozszerzoną (kolejność kolumn: $t,x,y,z$) i wykonujemy operacje elementarne:
\[
\left[
\begin{array}{rrrr|r}
-7&-3& 5& 2&-6\\
...
Następnie zerujemy pierwszą kolumnę pod pivotem:
\[
\begin{aligned}
R_2&\leftarrow 2R_2-5R_1,\\
...
Z trzeciego, czwartego i piątego wiersza dostajemy tę samą informację:
\[
z=-1.
\]

Po podstawieniu do drugiego i pierwszego równania z macierzy schodkowej:
\[
2x-y-4(-1)=2\ \Longrightarrow\ 2x-y=-2\ \Longrightarrow\ x=-1+\frac y2,
\]
\[
2t-y=2\ \Longrightarrow\ t=1+\frac y2.
\]
